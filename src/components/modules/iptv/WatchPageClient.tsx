...
export function WatchPageClient({ channelId }: WatchPageClientProps) {
  ...
  if (isError || !channel) {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 bg-[#0a0a0a] p-8 text-center">
        <p className="text-zinc-400">Channel not found or unavailable.</p>
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] pb-16">
      <div className="mx-auto max-w-6xl px-4 py-6 md:px-8">
        <Button asChild variant="ghost" className="mb-4 gap-2 text-zinc-400">
          <Link href="/">
        ...
        <HlsPlayer url={channel.url} title={channel.name} className="mb-6 shadow-2xl" />
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="space-y-2">
            ...
            <p className="max-w-2xl break-all text-xs text-zinc-500">
              {channel.url}
            </p>
          </div>
